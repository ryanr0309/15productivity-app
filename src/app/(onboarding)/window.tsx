...
const WINDOW_OPTIONS = [
  ...
  { icon: '🕐', label: '10 – 20 minutes',   sublabel: 'I can hold it briefly'              },
  { icon: '🕑', label: '20 – 45 minutes',   sublabel: 'I get a decent stretch going'       },
  { icon: '🕒', label: '45 – 90 minutes',   sublabel: 'I enter real deep work sometimes'   },
  { icon: '🌊', label: 'It depends',         sublabel: 'Good days vs bad days are worlds apart' },
];

export default function QWindowScreen() {
